...
/// One room, its drills. Free drills open; Bridge+ extra sets show the lock and
...
struct RoomView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showPaywall) { PaywallView(source: "bridge_room_sheet") }
    }
    ...
    private var upsell: some View {
        Button {
            ...
            VStack(spacing: 8) {
                ...
                Text("\(Membership.name) unlocks the extra sets here and in every other room, the Master Tables, Bridge Minute, Game Night Prep, and Endless Practice. Everything you already have stays free.")
                    .font(.caption)
                    .foregroundStyle(Theme.inkSecondary)
                    .multilineTextAlignment(.leading)
    ...
    private func destination(_ drill: Drill) -> some View {
        ...
        case .play(let scenarios):
            PlayDrillView(drill: drill, scenarios: scenarios)
        }
    }
}
