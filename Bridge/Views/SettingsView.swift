...
struct SettingsView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $showPaywall) { PaywallView(source: "bridge_settings_sheet") }
            ...
            .alert("Notifications are off", isPresented: $settings.reminderPermissionDenied) {
                ...
                Text("Bridge Trainer can't send your daily reminder until notifications are turned on for it in iOS Settings.")
            }
            .alert("Reset all progress?", isPresented: $showResetConfirm) {
                Button("Reset", role: .destructive) {
                    progress.resetAll()
                    PracticeRecordStore.shared.resetAll()
                    BridgeMinuteStore.shared.resetAll()
                }
    ...
    private var supportSection: some View {
        Section("Support") {
            ...
            Button {
                ...
                Label("Rate Bridge Trainer", systemImage: "star.fill")
            }
            Button {
    ...
    private var aboutSection: some View {
        Section("About") {
            ...
            Text("Bridge Trainer teaches beginner Standard American bidding, declarer play, and defense. Partnership agreements vary, so always confirm conventions with your partner.")
                .font(.footnote)
