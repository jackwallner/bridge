...
enum WhatsNew {
    ...
    static let releases: [WhatsNewRelease] = [
        WhatsNewRelease(
            version: "1.2.0",
            headline: "A smarter rhythm for the table",
            items: [
                WhatsNewItem(
                    id: "bridge-minute",
                ...
                WhatsNewItem(
                    ...
                    body: "Choose your usual bridge night and get a five-minute session built from your mistakes and weakest room when it matters.",
                    isPlus: true
                ),
                WhatsNewItem(
                    id: "ipad",
