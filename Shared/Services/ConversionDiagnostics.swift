...
/// On-device record of how someone met Bridge Plus before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.bridge", category: "Conversion")
    ...
    private static let impressionPrefix = "bridge_"
